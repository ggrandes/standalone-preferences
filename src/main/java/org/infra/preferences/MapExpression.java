...
class MapExpression {
	 ...
	 */
	public MapExpression(final String expression, final Mapper preMapper, final Mapper postMapper, final boolean evalInit)
			throws InvalidExpression {
	...
	public MapExpression(final String expression, final Map<String, String> postMap, final boolean evalInit)
			throws InvalidExpression {
		this(expression, null, new MultiMapper().add(new MapMapper(postMap))
				.add(SystemPropertyMapper.getInstance()), evalInit);
	}
